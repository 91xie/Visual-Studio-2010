...
namespace Assignment2Draft2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //  PROBLEM QUESTIONS
            /*
             * 1. Does the program take its date from a text file and puts it into an array? To do this, one would need to write code that could
             * 
             * 
             */
            ...
            //LakeStruct Test
            LakeStruct a = new LakeStruct(LakeNepressing[0, 0], LakeNepressing[0, 1], LakeNepressing[0, 2], LakeNepressing[0, 3]);
            Console.WriteLine(a);
            LakeStruct b = new LakeStruct(LakeNepressing[1, 0], LakeNepressing[1, 1], LakeNepressing[1, 2], LakeNepressing[1, 3]);
            Console.WriteLine(b);
            double StructSlope;
            StructSlope = LakeStruct.Slope(a, b);
            Console.WriteLine(StructSlope);
